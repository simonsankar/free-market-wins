...
Nothing about the adoption picture went the way he insisted it would, either:

- **January 2024**: the SEC approved spot Bitcoin ETFs — the exact "regulation" he said was overdue. It didn't strangle Bitcoin, it opened a pipe for institutional capital; those ETFs now hold well over $100 billion in assets.
- **MicroStrategy** ("Strategy") went from a mid-size corporate accumulator to the single largest known Bitcoin holder on the planet — over 800,000 BTC, more than $33 billion invested, ahead of BlackRock's spot ETF.
- **The US government** — the very state he trusted over "some random schmuck" — stood up a formal Strategic Bitcoin Reserve in 2025 and now holds roughly 325,000 BTC. The state didn't regulate Bitcoin into the ground. It started buying it.
- **El Salvador**, the "it failed" example from [Exhibit Three](#exhibit-three-citing-adoption-as-proof-of-failure), kept publicly buying — one BTC a day, on schedule — and now holds north of 7,700 BTC in its national reserve, still legal tender, five years after he called it dead.
- **Seven nations total** — El Salvador, the US, Pakistan, Bhutan, the UAE, the Czech Republic, and Brazil — now hold Bitcoin as a sovereign strategic reserve. Not the uncapped, abandoned, regulated-to-death asset he forecast.
