---
title: Practical Pricing in Bitcoin
date: 2024-12-27
---

### Pricing under Fiat
Under [[Fiat Currency]], we live under the assumption that prices _should_ rise. When the money supply is relatively low, prices for basic goods tended to be within the range of small numeric values, (some cents, a dollar, some dollars etc). But as the [[Cantillon Effect|money printer runs]], the purchasing power of these units become weaker and thus more is required to obtain the same good.
