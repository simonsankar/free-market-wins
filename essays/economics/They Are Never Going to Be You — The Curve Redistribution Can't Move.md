---
title: They Are Never Going to Be You — The Curve Redistribution Can't Move
date: 2026-07-30
---
...
That is not a political opinion. It is a job application. And the position being applied for is [[Parasitism|parasite]].
...
<text x="0" y="-28" font-size="15" font-weight="600" fill="var(--darkgray, #9a9a9a)">Two curves, one axis</text>
<path d="M0,300 C40,300 90,116 170,104 C250,92 290,214 370,258 C460,290 580,299 680,300" fill="#7a9ec2" fill-opacity="0.18" stroke="#7a9ec2" stroke-width="2.4"/>
<path d="M0,300 C160,300 340,298 430,270 C500,248 530,180 575,140 C605,113 635,120 652,168 C664,202 670,272 680,300" fill="var(--secondary, #e0932f)" fill-opacity="0.18" stroke="var(--secondary, #e0932f)" stroke-width="2.4"/>
<text x="176" y="88" font-size="13" font-weight="600" fill="#7a9ec2" text-anchor="middle">share of the people</text>
<text x="612" y="102" font-size="13" font-weight="600" fill="var(--secondary, #e0932f)" text-anchor="middle">share of the output</text>
...
<text x="680" y="322" font-size="12" fill="var(--gray, #9a9a9a)" text-anchor="end">hyper-productive</text>
<path d="M4,340 L4,348 L392,348 L392,340" fill="none" stroke="#7a9ec2" stroke-width="1.4"/>
<text x="198" y="370" font-size="12.5" fill="#7a9ec2" text-anchor="middle">most of the population lives here</text>
<path d="M470,340 L470,348 L676,348 L676,340" fill="none" stroke="var(--secondary, #e0932f)" stroke-width="1.4"/>
<text x="573" y="370" font-size="12.5" fill="var(--secondary, #e0932f)" text-anchor="middle">most of the output comes from here</text>
<text x="340" y="404" font-size="13" fill="var(--darkgray, #9a9a9a)" text-anchor="middle">The gap between the two humps is the whole argument.</text>
</g>
</svg>
...
<defs>
<path id="cdm-curve" d="M0,300 C32,300 64,160 116,148 C168,136 184,232 232,268 C280,296 320,299 360,300"/>
<clipPath id="cdm-clipA"><rect x="0" y="20" width="360" height="290"/></clipPath>
<clipPath id="cdm-clipB"><rect x="0" y="20" width="360" height="290"/></clipPath>
<marker id="cdm-arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path d="M0,1 L9,5 L0,9 z" fill="#e05a4f"/></marker>
</defs>
...
<text x="180" y="352" font-size="13" fill="var(--darkgray, #9a9a9a)" text-anchor="middle">Take from the tail, hand it to the mass,</text>
<text x="180" y="371" font-size="13" fill="var(--darkgray, #9a9a9a)" text-anchor="middle">and the mass becomes the tail.</text>
</g>
...
<text x="0" y="322" font-size="12" fill="var(--gray, #9a9a9a)">unproductive</text>
<text x="360" y="322" font-size="12" fill="var(--gray, #9a9a9a)" text-anchor="end">highly productive</text>
<text x="180" y="352" font-size="13" fill="var(--darkgray, #9a9a9a)" text-anchor="middle">The shape is untouched. The whole thing</text>
<text x="180" y="371" font-size="13" fill="var(--darkgray, #9a9a9a)" text-anchor="middle">slides left, and the tail relocates.</text>
</g>
</svg>
...
This is the same failure mode as [[The Capitalist Checkmate|the ideologically captured opponent]]: not an argument, a posture. And it doesn't require them to concede anything, because the argument doesn't run on their agreement. Flat-earthers exist and the planet stays round.
...
Related: [[The Capitalist Checkmate]] · [[Absurdity in paying it forward]] · [[The Economic Literacy Gradient - Why Nations Rise and Fall]] · [[The Confiscation Fantasy — Why Seizing Every Billionaire Wouldn't Help You]] · [[Parasitism]] · [[Socialism is impossible]]
