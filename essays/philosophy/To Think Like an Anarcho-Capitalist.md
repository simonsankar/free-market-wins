...
- **Late-comer ethic**: Destroys all incentive to improve anything. Why plant crops if someone can claim them later?
- **Utilitarian redistribution**: Requires subjective judgments about "best use" and "need" - creating a permanent class of dictators.
- **Democratic/majority rule**: The majority can vote to steal from the minority. Endless warfare between groups.
- **Common ownership**: An oxymoron. Ownership means exclusive control. If everyone owns something, no one does. Results in tragedy of the commons.
...
- How much to produce (scarcity signals)
- What methods to use (cost efficiency)
...
- Aggression is illegitimate (proven by argumentation ethics)
- Property rights flow from self-ownership (proven by self-ownership axiom)
- Free markets are economically necessary (proven by economic calculation problem)
- The state is inherently aggressive (proven by definition - monopoly on violence)
